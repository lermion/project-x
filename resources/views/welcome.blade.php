...
<!-- End Google Tag Manager (noscript) -->
	...
	<header ng-cloak ng-if="$root.isAuthorized && $root.showHeader && !(currentPath === '/auth/login' || currentPath === '/' || currentPath === '/auth/registration' || currentPath === '/auth/restore' || currentPath === '/auth/invite')">
		<div class="header header-user">
			...
			<div class="menu-item" ng-show="showMenu">
				...
				<a class="chat" ui-sref="chat.list"> Чаты <span ng-if="countChatMessages > 0 && currentPath !== '/chat/list'" class="places-count-span">@{{countChatMessages}}</span></a>
	...
	<script src="../../app/libs/ng-img-crop-full-extended/compile/unminified/ng-img-crop.js"></script>
	...
	<script src="../../app/libs/angular-img-cropper.min.js"></script>
