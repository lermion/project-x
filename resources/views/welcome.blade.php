...
<body ng-controller="mainCtrl" ng-class="bodyClass">
	...
	<header ng-cloak ng-if="$root.userLogged" ng-hide="currentPath === '/auth/login' || currentPath === '/' || currentPath === '/auth/registration'">
	...
	<header ng-cloak ng-hide="currentPath === '/auth/login' || currentPath === '/' || currentPath === '/auth/registration'" ng-if="!$root.userLogged">
		<div class="header">
